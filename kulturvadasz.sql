...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Jan 27. 10:08
...
INSERT INTO `felhasznalo` (`id`, `email`, `jelszo_hash`, `nev`, `telefon`, `aktiv`, `letrehozva`, `utoljara_be`, `utoljara_mod`) VALUES
(1, 'admin@gasztrovadasz.hu', '$2y$10$adminhash', 'Admin András', '06301111111', 1, '2026-01-27 10:08:20', NULL, NULL),
(2, 'szervezo@gasztrovadasz.hu', '$2y$10$szervezohash', 'Borbély Zsófia', '06302222222', 1, '2026-01-27 10:08:20', NULL, NULL),
(3, 'vende g@gasztrovadasz.hu', '$2y$10$userhash', 'Nagy Péter', NULL, 1, '2026-01-27 10:08:20', NULL, NULL);
...
--
-- A tábla adatainak kiíratása `felhasznalo_szerep`
--
...
INSERT INTO `jelentkezes` (`id`, `felhasznalo_id`, `irszam`, `turafajta_id`, `datum`, `letszam`, `megjegyzes`, `letrehozva`, `modositva`) VALUES
(1, 3, '3910', 8, '2026-04-18', 2, 'Tokaji bor- és pincelátogatás', '2026-01-27 10:08:20', NULL),
(2, 3, '7773', 8, '2026-05-22', 4, 'Villányi borkóstoló helyi termelőknél', '2026-01-27 10:08:20', NULL),
(3, 2, '6500', 7, '2026-06-12', 10, 'Bajai halászléfőző gasztroprogram', '2026-01-27 10:08:20', NULL),
(4, 3, '6720', 7, '2026-03-30', 3, 'Szegedi paprika és piac túra', '2026-01-27 10:08:20', NULL);
...
--
-- A tábla adatainak kiíratása `tajegyseg`
--

INSERT INTO `tajegyseg` (`id`, `nev`) VALUES
(1, 'Tokaj-Hegyalja'),
(2, 'Balaton-felvidék'),
(3, 'Alföld'),
(4, 'Villányi borvidék');
