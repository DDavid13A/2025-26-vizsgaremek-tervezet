...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Feb 22. 18:31
...
--
-- Tábla szerkezet ehhez a táblához `tour_dates`
--
...
--
-- A tábla adatainak kiíratása `tour_dates`
--
...
--
-- Tábla szerkezet ehhez a táblához `tour_destinations`
--
...
--
-- A tábla adatainak kiíratása `tour_destinations`
--
...
--
-- A tábla indexei `tour_destinations`
--
...
--
-- AUTO_INCREMENT a táblához `tour_dates`
--
ALTER TABLE `tour_dates`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT a táblához `tour_destinations`
--
ALTER TABLE `tour_destinations`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
ALTER TABLE `password_resets`
  ...
  ADD CONSTRAINT `password_resets_ibfk_2` FOREIGN KEY (`requested_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;
